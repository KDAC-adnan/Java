			...
			do {
				...
				case 1: {
					...
					if (library.contains(book)) {
						library.get(library.indexOf(book))
								.setQuantity(library.get(library.indexOf(book)).getQuantity() + quantity);
						System.out.println("Quantity of book " + isbn + " increased by "+quantity);
					} else {
